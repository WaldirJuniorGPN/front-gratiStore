...
function renderizarTabela(registros) {
  ...
  header.innerHTML =
    "<th>Data</th><th>Entrada</th><th>Início Almoço</th><th>Fim Almoço</th><th>Saída</th><th>Feriado?</th><th>Ações</th>";
...
async function buscarPontos() {
  ...
  const registros = historico.filter(
    (r) => r.atendenteId === atendenteId && r.data.startsWith(`${ano}-${mes}`)
  );
