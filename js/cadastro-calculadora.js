...
document.addEventListener("DOMContentLoaded", () => {
  ...
  carregarLojas();
  document
    .getElementById("formCadastroCalculadora")
    .addEventListener("submit", cadastrarCalculadora);
});
...
async function cadastrarCalculadora(event) {
  ...
  try {
    const response = await fetch("http://172.16.222.65:8080/calculadoras", {
      method: "POST",
      headers: {
