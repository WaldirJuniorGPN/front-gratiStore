...
document
  .getElementById("formCadastroAtendente")
  .addEventListener("submit", cadastrarAtendente);
...
async function cadastrarAtendente(event) {
  ...
  try {
    const response = await fetch("http://172.16.222.65:8080/atendentes", {
      method: "POST",
      headers: {
